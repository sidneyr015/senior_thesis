...
async def call_mcp_tool(query, mode="all", path="/path/to/project"):
    ...
    process = await asyncio.create_subprocess_exec(
        "octocode", "mcp", "--path", path, "--with-lsp", "rust-analyzer",
...
async def main():
    result = await call_mcp_tool("enum", path="/Users/sidneyrichardson/senior_thesis-1/code_examples/personal_once_cell")
